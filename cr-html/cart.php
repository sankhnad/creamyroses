  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
              ...
              <ul class="products-grid">
                ...
                <li class="item col-lg-3 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="product-detail.php" title="Retis lapen casen" class="product-image"><img src="assets/products-images/product16.jpg" alt="Retis lapen casen"></a>
                ...
                <li class="item col-lg-3 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="product-detail.php" title="Retis lapen casen" class="product-image"><img src="assets/products-images/product19.jpg" alt="Retis lapen casen"></a>
                        <div class="new-label new-top-left">New</div>
                ...
                <li class="item col-lg-3 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a href="product-detail.php" title="Retis lapen casen" class="product-image"><img src="assets/products-images/product22.jpg" alt="Retis lapen casen"></a>
                        <div class="new-label new-top-left">New</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button> <button type="button" class="btn btn-success">Continue</button>
      </div>
    </div>
