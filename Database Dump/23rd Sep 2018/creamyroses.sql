...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 23, 2018 at 04:25 PM
...
DROP TABLE IF EXISTS `admin_audittrail`;
CREATE TABLE IF NOT EXISTS `admin_audittrail` (
...
(320, 1, 0, '192.168.0.108', 'Login', 'Success', 'a:1:{s:7:\"trigger\";i:1;}', '2018-09-23 15:27:08');
...
DROP TABLE IF EXISTS `admin_contact_us`;
...
DROP TABLE IF EXISTS `admin_message_template`;
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  `button_link` text,
  `avtar` varchar(300) DEFAULT NULL,
  `isDeleted` tinyint(2) NOT NULL DEFAULT '1' COMMENT '1:active; 2:delete',
...
INSERT INTO `banner` (`bid`, `heading`, `description`, `button_text`, `button_link`, `avtar`, `isDeleted`, `status`, `created_on`) VALUES
(1, 'Example Headline', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.\r\n\r\nCras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Sign up today', '#', 'slide1.jpg', 0, 0, '2018-07-26 06:36:51'),
(2, 'Another example Headline.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Learn more', '#', 'slide2.jpg', 1, 1, '2018-07-27 05:47:22'),
(3, 'One more for good measure.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Browse gallery', '#', 'slide3.jpg', 1, 1, '2018-07-27 05:48:15'),
(4, 'One more for good measure.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.\r\nCras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Browse gallery', '#', 'slide4.jpg', 1, 1, '2018-07-27 05:49:02'),
(5, 'One more for good measure.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Browse gallery', '#', 'slide5.jpg', 1, 1, '2018-07-27 05:49:54');
...
DROP TABLE IF EXISTS `customer_group_member`;
...
DROP TABLE IF EXISTS `delivery_option_slot`;
CREATE TABLE IF NOT EXISTS `delivery_option_slot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `location_pin` (
...
(3, 'INV58102', NULL, 2, 22, 'Raj Mishra ed,jaikaushik2012@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Early Morning Delivery', '08:00 AM - 10:00 AM', 150, 0, 2, 1, '2018-09-23 13:30:55'),
(4, 'INV61039', NULL, 2, 22, 'Raj Mishra ed,jaikaushik2012@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, sdsdsdsd, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '9', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 14:37:12'),
(5, 'INV24250', NULL, 2, 22, 'Raj Mishra ed,jai123@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 14:41:59'),
(6, 'INV42645', NULL, 2, 22, 'Raj Mishra ed,jaikaushik2012@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 14:50:36'),
(7, 'INV37131', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 14:54:31'),
(8, 'INV14260', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, asasas, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 14:57:48'),
(9, 'INV85427', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '9', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 15:02:25'),
(10, 'INV68414', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', '', '', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 15:05:43'),
(11, 'INV82352', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '16', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 15:11:45'),
(12, 'INV61150', NULL, 2, 22, 'Raj Mishra ed,raj1223@gmail.com,D-15/44,Ganga Vihar, Delhi,Delhi,jk2,Near Ganga Public School', 'Jai Kaushik, jaikaushik2012@gmail.com, D-15/4, Ganga Vihar, Delhi, Delhi, Delhi22, Near Ganga Public School', '110094', '9871145277', '110056', '9871123454', 'CouponOne', '9', '2018-09-24', 'Midnight Delivery', '10:00 PM - 11:00 PM', 150, 0, 2, 1, '2018-09-23 15:45:08');
...
(4, '7ZYJYTVMR74P51S', 1, 22, 13, 110094, 1, 64, 700, 250, 450, 'gm', '', 3, 0, '2018-09-20 10:12:01'),
(5, '7ZYJYTVMR74P51S', 2, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', '', 4, 0, '2018-09-20 12:19:02'),
(6, '1RBR86HCYJUT8A1', 3, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', '', 1, 0, '2018-09-23 07:14:05'),
(7, '17AB04E4YSKCGU2', 5, 22, 13, 110094, 1, 64, 700, 250, 450, 'gm', '', 1, 0, '2018-09-23 08:17:19'),
(8, '321J2MA7334KCXX', 5, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', 'asasasa', 1, 0, '2018-09-23 09:09:58'),
(9, 'JSFW8MXC593QVBG', 6, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', '', 1, 0, '2018-09-23 09:19:43'),
(10, '6BTVGHGBZUJHZPT', 7, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', '', 1, 0, '2018-09-23 09:23:13'),
(11, 'MXB0XTFC2X9WHJ3', 8, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', 'ssdsds', 1, 0, '2018-09-23 09:26:35'),
(12, '7AJ3Y6FA1QFBZ83', 9, 22, 13, 110094, 1, 64, 700, 250, 450, 'gm', '', 1, 0, '2018-09-23 09:31:19'),
(13, 'GHU70UVP1TFR6JM', 10, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', '', 1, 0, '2018-09-23 09:34:43'),
(14, 'XH7HNS5HAHT0WH1', 11, 22, 13, 110094, 1, 65, 1000, 20, 800, 'gm', 'sdsdsdsds', 1, 0, '2018-09-23 09:40:51'),
(15, 'XH7HNS5HAHT0WH1', 12, 22, 13, 734006, 1, 74, 700, 250, 450, 'gm', '', 1, 0, '2018-09-23 10:13:59');
...
(1, 'cake1222', 'cake1222', NULL, 1, '<p>sasdsdsdssdsdsdsd<br></p>', NULL, '32', '2018-08-27', 4, 1, NULL, NULL, NULL, NULL, NULL, 0, '2018-07-05 18:41:16', '2018-08-06 00:11:16'),
(2, 'cake edit', 'cake-edit', NULL, 1, '<p>sasasa<br></p>', '05585257cad21f07a384ccf711709337.jpg', 'sku ed', '2018-08-10', 44, 0, NULL, NULL, NULL, NULL, NULL, 0, '2018-08-05 18:50:55', '2018-08-06 00:20:55'),
(3, 'Chocolate Cream', 'chocolate-cream', '', 1, '<p>sasasa<br></p><div class=\"tab-pane fade active in\" id=\"product_tabs_custom\">\r\n                                                <div class=\"product-tabs-content-inner clearfix\">\r\n                                                    <p><strong>Lorem Ipsum</strong><span> is\r\n                                                        simply dummy text of the printing and typesetting industry. Lorem Ipsum\r\n                                                        has been the industry\'s standard dummy text ever since the 1500s, when \r\n                                                        an unknown printer took a galley of type and scrambled it to make a type\r\n                                                        specimen book. It has survived not only five centuries, but also the \r\n                                                        leap into electronic typesetting, remaining essentially unchanged. It \r\n                                                        was popularised in the 1960s with the release of Letraset sheets \r\n                                                        containing Lorem Ipsum passages, and more recently with desktop \r\n                                                        publishing software like Aldus PageMaker including versions of Lorem \r\n                                                        Ipsum.</span>\r\n                                                    </p>\r\n                                                </div>\r\n                                            </div>', 'a9d5cca6ac777832800c40de5cda8998.jpg', 'Chocolate Cream Cake', '2018-09-03', 2, 1, 'Meta Tag Title', 'Meta Tag Keywords', 'Meta Tag Description', '<p> Delivery DeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDeliveryDelivery</p>', '<p>RefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefundRefund</p>', 1, '2018-04-05 19:42:19', '2018-08-06 01:12:19'),
(4, 'test product', 'test-product', NULL, 1, '<p>sasasasas<br></p>', NULL, '32', '2018-08-28', 3, 1, '', '', '', '', '', 0, '2018-08-08 01:22:35', '2018-08-08 06:52:35'),
(5, 'cake New Wala', 'cake-new-wala', NULL, 1, '<p>ddsdsds</p><p>d</p><p>sd</p><p>sd</p><p>sd</p><p><br></p>', 'bc4979b1ef650103c9934977932af2a3.jpg', '32', '2018-08-21', 4, 1, '', '', '', '', '', 0, '2018-08-12 04:18:13', '2018-08-12 09:48:13'),
(6, 'cake New Wala qq', 'cake-new-wala-qq', NULL, 1, '<p>ddsdsds</p><p>d</p><p>sd</p><p>sd</p><p>sd</p><p><br></p>', '853ffa2917384cc3f7d305ba255d3460.jpg', '32', '2018-08-21', 4, 1, 'sdsds', 'sdsd', 'sddsd', 's<p>dsdsdsdsd<br></p>', '<p>sdsdsdsd</p><p>sd</p><p>sd</p><p>s</p><p>d<br></p>', 0, '2018-06-12 04:21:47', '2018-08-12 09:51:47'),
(7, 'cake New Wala qq jhjhjhjh mhjhjh', 'cake-new-wala-qq-jhjhjhjh-mhjhjh', NULL, 1, '<p>ddsdsds</p><p>d</p><p>sd</p><p>sd</p><p>sd</p><p><br></p>', '1b2935dae7034d46b0a5af700dbc62c8.jpg', '32', '2018-08-21', 4, 1, 'sdsds', 'sdsd', 'sddsd', 's<p>dsdsdsdsd<br></p>', '<p>sdsdsdsd</p><p>sd</p><p>sd</p><p>s</p><p>d<br></p>', 0, '2018-06-12 04:22:42', '2018-08-12 09:52:42'),
(8, 'ggg', 'ggg', NULL, 1, '<p>ddsdsds</p><p>d</p><p>sd</p><p>sd</p><p>sd</p><p><br></p>', '5eed620f2f017d2bb388070cb43ab7c4.jpg', '32', '2018-08-21', 4, 1, 'sdsds', 'sdsd', 'sddsd', 's<p>dsdsdsdsd<br></p>', '<p>sdsdsdsd</p><p>sd</p><p>sd</p><p>s</p><p>d<br></p>', 0, '2018-08-12 04:23:36', '2018-08-12 09:53:36'),
(9, 'Choko Cake', 'choko-cake', NULL, 1, '<p>sdsdsds</p><p>d</p><p>sd</p><p>sd</p><p>s</p><p>d</p><p>s<br></p>', 'b5c6d90c0783ed75717caa4cadf131ff.jpg', '32', '2018-08-21', 4, 1, 'sdsdsdsds', 'sdsd', 'sddsd', '<p>dsdsds<br></p>', '<p>sdsdsdsd<br></p>', 0, '2018-08-12 04:38:26', '2018-08-12 10:08:26'),
(10, 'Fruit Cake', 'fruit-cake', NULL, 1, 'Fruit Cake<br>', '1a925937e0d5c8d58c944f89f697ce14.jpg', 'Fruit', '2018-08-22', 3, 1, 'Meta Tag Title', 'Meta Tag Keywords', 'Meta Tag Description Meta Tag Description Meta Tag Description', '', '', 0, '2018-08-12 06:31:27', '2018-08-12 12:01:27'),
(11, 'Cake One', 'cake-one', NULL, 1, '<p>sasasasasas<br></p>', '8b637f24f550dfb31fdb709d3e700df3.jpg', 'qw11', '2018-08-23', 2, 1, 'Meta Tag Title', 'Meta Tag Keywords', 'Meta Tag Description', '<p>DeliveryDeliveryDeliverysdsdsdsds</p>', '<p>kjhjhjh<br></p>', 0, '2018-08-12 07:09:46', '2018-08-12 12:39:46'),
(12, 'Cake Triangle', 'cake-triangle', NULL, 1, '<p>sasasasasas<br></p>', '3f32b8f5f4e6751b60812f8bdeedb834.jpg', 'qw11', '2018-08-23', 2, 1, 'Meta Tag Title', 'Meta Tag Keywords', 'Meta Tag Description', '<p>DeliveryDeliveryDeliverysdsdsdsds</p>', '<p>kjhjhjh<br></p>', 0, '2018-08-12 07:11:37', '2018-08-12 12:41:37'),
(13, 'Fruit Cake', 'fruit-cake', '', 1, '<p>sasasa<br></p><div class=\"tab-pane fade active in\" id=\"product_tabs_custom\">\r\n                                                <div class=\"product-tabs-content-inner clearfix\">\r\n                                                    <p><strong>Lorem Ipsum</strong><span> is\r\n                                                        simply dummy text of the printing and typesetting industry. Lorem Ipsum\r\n                                                        has been the industry\'s standard dummy text ever since the 1500s, when \r\n                                                        an unknown printer took a galley of type and scrambled it to make a type\r\n                                                        specimen book. It has survived not only five centuries, but also the \r\n                                                        leap into electronic typesetting, remaining essentially unchanged. It \r\n                                                        was popularised in the 1960s with the release of Letraset sheets \r\n                                                        containing Lorem Ipsum passages, and more recently with desktop \r\n                                                        publishing software like Aldus PageMaker including versions of Lorem \r\n                                                        Ipsum.</span>\r\n                                                    </p>\r\n                                                </div>\r\n                                            </div>', '7f4486a4cf5b7a538fef335d623a31b7.jpg', 'fff1222', '2018-08-28', 4, 1, 'asasasa', '', '', '<div class=\"tab-pane fade active in\" id=\"product_tabs_custom\">\r\n                                                <div class=\"product-tabs-content-inner clearfix\">\r\n                                                    <p><strong>Lorem Ipsum</strong><span> is\r\n                                                        simply dummy text of the printing and typesetting industry. Lorem Ipsum\r\n                                                        has been the industry\'s standard dummy text ever since the 1500s, when \r\n                                                        an unknown printer took a galley of type and scrambled it to make a type\r\n                                                        specimen book. It has survived not only five centuries, but also the \r\n                                                        leap into electronic typesetting, remaining essentially unchanged. It \r\n                                                        was popularised in the 1960s with the release of Letraset sheets \r\n                                                        containing Lorem Ipsum passages, and more recently with desktop \r\n                                                        publishing software like Aldus PageMaker including versions of Lorem \r\n                                                        Ipsum.</span>\r\n                                                    </p>\r\n                                                </div>\r\n                                            </div>', '<div class=\"tab-pane fade active in\" id=\"product_tabs_custom\">\r\n                                                <div class=\"product-tabs-content-inner clearfix\">\r\n                                                    <p><strong>Lorem Ipsum</strong><span> is\r\n                                                        simply dummy text of the printing and typesetting industry. Lorem Ipsum\r\n                                                        has been the industry\'s standard dummy text ever since the 1500s, when \r\n                                                        an unknown printer took a galley of type and scrambled it to make a type\r\n                                                        specimen book. It has survived not only five centuries, but also the \r\n                                                        leap into electronic typesetting, remaining essentially unchanged. It \r\n                                                        was popularised in the 1960s with the release of Letraset sheets \r\n                                                        containing Lorem Ipsum passages, and more recently with desktop \r\n                                                        publishing software like Aldus PageMaker including versions of Lorem \r\n                                                        Ipsum.</span>\r\n                                                    </p>\r\n                                                </div>\r\n                                            </div>', 1, '2018-08-29 23:30:46', '2018-08-30 05:00:46');
...
(11, 3, '9ad255373840d1c4b11f76d08c2809dc.jpg'),
(12, 3, '3a3de026f501a2d4d16dcdcffb841981.jpg'),
(13, 3, '5cc4f8572902872dd36521a64ec6e351.jpg');
...
(1, 400, 'kg', '2', 400.00, 'F', '400.00'),
(2, 300, 'kg', '1', 300.00, 'F', '500.00'),
(3, 10, 'gm', '500', 800.00, 'F', '100.00'),
(4, 10, 'kg', '1', 2000.00, 'F', '10.00'),
(9, 6, 'gm', '2', 3.00, 'F', '1.00'),
(74, 13, 'gm', '250', 700.00, 'F', '250.00'),
(73, 13, 'gm', '500', 1000.00, 'P', '20.00'),
(72, 13, 'kg', '1', 1500.00, 'F', '50.00'),
(76, 3, 'gm', '250', 500.00, 'F', '100'),
(75, 3, 'gm', '500', 1000.00, 'F', '200');
...
DROP TABLE IF EXISTS `product_to_delivary_option`;
CREATE TABLE IF NOT EXISTS `product_to_delivary_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `product_to_related`;
CREATE TABLE IF NOT EXISTS `product_to_related` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
(7, 22, 3, 0, 0, '2018-09-23 13:30:55'),
(8, 22, 4, 0, 0, '2018-09-23 14:37:12'),
(9, 22, 5, 0, 0, '2018-09-23 14:41:59'),
(10, 22, 6, 0, 0, '2018-09-23 14:50:36'),
(11, 22, 7, 0, 0, '2018-09-23 14:54:31'),
(12, 22, 8, 0, 0, '2018-09-23 14:57:48'),
(13, 22, 9, 0, 0, '2018-09-23 15:02:25'),
(14, 22, 10, 0, 0, '2018-09-23 15:05:43'),
(15, 22, 11, 0, 0, '2018-09-23 15:11:45'),
(16, 22, 12, 0, 0, '2018-09-23 15:45:08');
...
CREATE TABLE IF NOT EXISTS `testimonials` (
  ...
  `short_desc` text,
  `description` text,
  `isDeleted` tinyint(2) NOT NULL DEFAULT '1' COMMENT '0:delete;1:active',
...
INSERT INTO `testimonials` (`tid`, `name`, `designation`, `company`, `avtar`, `short_desc`, `description`, `isDeleted`, `status`, `created_on`) VALUES
(1, 'Don Know', 'Important person', 'some Company', NULL, 'fd 3d', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. ', 1, 1, '2018-07-26 08:54:29'),
(2, 'Don Know', 'Important person', 'some Company', NULL, NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. \r\n\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1, 1, '2018-07-27 06:32:46'),
(3, 'Don Know', 'Important person', 'some Company', NULL, NULL, ' Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\n\r\n Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1, 1, '2018-07-27 06:33:43'),
(4, 'Don Know', 'Important person', 'some Company', NULL, NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. \r\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1, 1, '2018-07-27 06:34:42'),
(5, 'Standard Delivery', 'MSC', 'PS Quick IT', NULL, NULL, 'Sorry, the page you are looking for is not available. Maybe this is an broken URL  Sorry, the page you are looking for is not available. Maybe this is an broken URL Sorry, the page you are looking for is not available. Maybe this is an broken URL.', 1, 1, '2018-09-23 02:42:25');
...
(18, 'Recent Gift', 'recent-gift', NULL, NULL, 0, 0, 3, '', '', '', 1, 0, 0, '2018-08-14 21:22:05', '2018-08-14 21:22:05'),
(19, 'Corporate Gift', 'corporate-gift', NULL, NULL, 0, 0, 4, '', '', '', 1, 0, 0, '2018-08-14 21:22:34', '2018-08-14 21:22:34'),
(20, 'Extra Benifits', 'extra-benifits', NULL, NULL, 0, 0, 5, '', '', '', 1, 0, 0, '2018-08-14 21:23:35', '2018-08-14 21:23:35');
