									...
									<table>
										...
										<tfoot>
											...
											<tr>
												...
												<td class="text-right">
													<strong class="rewardBalnce">-&nbsp;<i class="fas fa-rupee-sign"></i>&nbsp;
														<span class="amount">
															<?php
																$currentBal = getRewardBalance();
																echo $currentBal > 50 ? '50.00' : number_format($currentBal,2);
															?>
														</span>
													</strong>
												</td>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<?php
					if(!$addressList){
						echo 'No address added yet. If you want to add new address please <a target="_blank" href="'.base_url().'add-address">click here</a>.';
					}
