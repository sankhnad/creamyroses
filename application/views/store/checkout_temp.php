											...
											<tr>
												<td>
													<div class="input-group date dateDelivryInp" data-provide="datepicker">
														<input type="text" onChange="getProductDeliverySlot(this, 'date')" value="<?=date("d/m/Y", strtotime("+ 1 day"))?>" class="form-control">
												...
												<td>
													<select class="selectpicker slotTimeList" onChange="getProductDeliverySlot(this, 'slot')" data-live-search="true" title="Select Time of Delivery" data-width="100%">
