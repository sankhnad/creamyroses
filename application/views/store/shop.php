                    ...
                    <div class="col-sm-9 col-sm-push-3">
                        ...
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li class="category1599"> <a href="#" >Shop</a> <!-- <span>/</span> --> </li>
                            ...
                            <div class="slider-items-products">
                                <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                                    <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                                        <!-- Item -->
                                        <div class="item"> <a href="#"><img alt="" src="assets/images/category-img1.jpg" width="100%" ></a> </div>
                                        <!-- End Item --> 
                                        <!-- Item -->
                                        <div class="item">
                                            <a href="#"><img alt="" src="assets/images/category-img2.jpg" width="100%"></a> 
                                            <!-- End Item --> 
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="item-inner">
                                            <div class="item-img">
                                                <div class="item-img-info">
                                                    ...
                                                    <div class="label-wishlist"><i class="fab fa-gratipay"></i></div>
                                                </div>
                                            </div>
                                            <div class="item-info">
