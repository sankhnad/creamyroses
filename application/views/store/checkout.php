		...
		<div class="container-fluid">
			<div class="row">
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
                                                ...
                                                to Billing Information&raquo;</a>
												</div>
											</h4>
										</div>
									</div>
											...
											<div class="panel-body">
												<table class="table table-striped" style="font-weight: bold;">
													<tr>
														...
														<td><a href="#" class="btn btn-success btn-sm">use this address</a>
														</td>
														<td style="width: 100px;"><a href="#" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> <a href="#" class="btn btn-danger btn-sm"><i class="fa fa-times-circle"></i></a>
														</td>
													</tr>
													<tr>
														<td>2</td>
												...
												<div class="row">
													<div class="col-md-7">
														<table class="table" border="1">
															...
															<tbody>
																<tr>
																	<td><img src="https://d24pyncn3hxs0c.cloudfront.net/sites/default/files/styles/uc_cart/public/love-quotient-9988317gf-A.jpg?itok=v4Jd1Rqm">
																	</td>
																	<td>1</td>
																	<td>Love Quotient<br/><small><a href="#" >Uploaded Image</a></small>
																	</td>
																	<td>Rs.499</td>
																</tr>
															</tbody>
														...
														<div class="coupon-form-wrap">
															<div class="js-coupon-container" style="display: block;">
																...
																<div class="content">
																	<div class="form-item form-type-textfield form-item-code"> <input placeholder="Enter coupon code" type="text" id="edit-code" name="code" value="" size="15" maxlength="128" class="form-text">
																	</div>
																		...
																		<div class="form-item form-type-radios form-item-panes-payment-payment-method form-disabled">
																			<div class="form-radios" id="edit-panes-payment-payment-method--2">
																				<div class="form-item form-type-radio form-item-panes-payment-payment-method form-disabled">
																					<div class="payment-radios"><input type="radio" name="optradio" class="form-radio ajax-processed" checked="checked" id="edit-panes-payment-payment-method-secureebs--2"><label class="option">Payment via <strong><font size="3" color="#666666">Debit Card</font></strong> or <strong><font size="3" color="#FF9900">Net Banking</font></strong> </label>
																					</div>
																					<div class="payment-radios"> <input type="radio" name="optradio" class="form-radio ajax-processed" id="edit-panes-payment-payment-method-secureebs--3"> <label class="option">Payment via <strong><font size="3" color="#FF9900">Credit Card</font></strong> </label>
																					</div>
																					<div class="payment-radios"> <input type="radio" name="optradio" class="form-radio ajax-processed" id="paypal-wps"> <label class="option">Payment via <img src="https://d598e6i8i1kkq.cloudfront.net/sites/all/themes/facd7/images/checkout/paypal.png"></label>
																					</div>
																					<div class="payment-radios"> <input type="radio" name="optradio" class="form-radio ajax-processed" id="payumoney"> <label class="option">Payment via <img src="https://d598e6i8i1kkq.cloudfront.net/sites/all/themes/facd7/images/checkout/pay-u-money-logo.png" style="vertical-align: middle;"> </label>
																					</div>
																					<div class="payment-radios"> <input type="radio" name="optradio" class="form-radio ajax-processed" id="mobikwik"><label class="option">Payment via MobiKwik </label>
																					</div>
																					<div class="payment-radios"> <input type="radio" name="optradio" class="form-radio ajax-processed" id="paytm"><label for="paytm" class="option">Payment via <img src="https://d598e6i8i1kkq.cloudfront.net/sites/all/themes/facd7/images/checkout/paytm.png"> </label>
																					</div>
																				</div>
																			</div>
																		</div>
				...
				<aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9">
					<div class="side-banner"><img src="<?=base_url()?>assets/store/images/side-banner.jpg" width="100%" alt="banner">
					</div>
				</aside>
			</div>
		</div>
