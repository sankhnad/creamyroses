        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="footer-column pull-left">
              <h4>About </h4>
              <p>Cakes is an online cake ordering website that delivers cakes in Noida, Greater Noida & Ghaziabad.</p>
              <a href="#"><img src="<?=$iURL_storeAssts?>images/google-play.png" /></a>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                ...
                <li><a href="#" title="Search Terms">Delivery Information</a></li>
                <li><a href="#" title="Site Map">Privacy Policy</a></li>
                <li><a href="#" title="Advanced Search">Terms & Conditions</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                ...
                <li><a href="#" title="Addresses">Wish List</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="contacts-info">
              <address>
              <i class="add-icon">&nbsp;</i>New Delhi,<br /> &nbsp;110044(India)
              </address>
              <div class="phone-footer"><i class="phone-icon">&nbsp;</i> +91-9999 5858-12</div>
              <div class="email-footer"><i class="email-icon">&nbsp;</i> <a href="mailto:help@cakeanytime.in">help@cakes.in</a> </div>
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
      	...
      	Copyright &copy; 2018  Cakes. All Rights Reserved. <!-- Powered By <a href="http://webrinfotech.com/"> Web Revolution Info Tech</a>-->
      	</div>
        </div>
      </div>
    </div>
