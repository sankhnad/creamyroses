...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<div class="headPageA">
								<div class="titleAre"><i class="fas fa-users"></i> Customers List</div>
								<div class="buttonAre">
									<a href="<?=admin_url()?>customers/add" class="btn btn-primary"><i class="ace-icon fas fa-plus"></i> Add Customer</i></a>
								</div>
							</div>
	...
	<script>
		function filterRecord() {
			...
			ajaxPageTarget('data_table', 'customers', 'customer_list' );
		}
		filterRecord();
	</script>
</body>
