...
<head>
	...
	<title>Orders List | POCHI Admin</title>
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?=admin_url()?>orders">Orders</a>
						</li>
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<div class="headPageA">
								<div class="titleAre"><i class="far fa-id-card"></i> Orders List</div>
								<!--<div class="buttonAre">
							...
							<div class="filterPageare">
								...
								<div class="filterPanL">
									<select class="selectpicker filter_status" title="Select Status" data-live-search="true" data-width="fit" data-selected-text-format="count" data-size="5" multiple data-actions-box="true">
										...
										<option value="1">Way On Delivery</option>
	...
	<script>
		function filterRecord() {
			...
			ajaxPageTarget('data_table', 'orders', 'orders_lst' );
		}
		filterRecord();
