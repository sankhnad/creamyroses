    ...
    <tr>
      <td><table style="width:100%; max-width:1100px;" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="width:220px; text-align:center; padding:5px; font-family:Arial, Helvetica, sans-serif; font-size:16px;"><span style=" border:dashed 2px #666666; float:right; padding:5px 10px;">Invoice No. #<?=$orderObj[0]->invoice_no;?></span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      ...
      <td style="border-top:solid 1px #333333;">
                <table width="1100px" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
                    ...
                    <tr>
                        ...
                        <td width="200px" style="text-align:right; border-bottom:#333 solid 1px; padding:5px 10px;"><?=$row->unit?></td>
                        <td width="200px" style="text-align:right; border-bottom:#333 solid 1px; padding:5px 10px;"><?=$row->quantity?></td>
                        <td width="200px" style="text-align:right; border-bottom:#333 solid 1px; padding:5px 10px;"><?=round($row->total_price,2)?></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; padding:5px 10px;"> <?=round(234,2);?></td>
                    </tr>
                    <tr>
                    	<td colspan="4" style="padding-top:15px; text-align:right; padding:5px 10px;"><b>Total</b><br />
						</td>
                        <td style="text-align:right; padding:5px 10px;"><b> <?=round(879,2);?></b></td>
                    </tr>
                ...
                <table width="100%" cellpadding="5" style="font-family:Arial, Helvetica, sans-serif; font-size:28px;">
                	<tr>
                    	<td></td>
                        <td width="35%" style="text-align:right; padding:5px 10px;">Discount Coupan Applied on <?=$orderObj[0]->coupon;?></td>
