...
<head>
	...
	<title>Banner List | Traveller India Web Admin </title>
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">
							<a href="<?=admin_url()?>banner">Banner</a>
						</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<div class="headPageA">
								<div class="titleAre"><i class="fas fa-users"></i> Banner List</div>
								<div class="buttonAre">
									<a class="btn btn-primary" href="<?=admin_url()?>banner/add"><i class="ace-icon fas fa-user-plus bigger-110"></i> Add New Banner</i></a>
								</div>
							</div>
	...
	<script>
		function filterRecord() {
			...
			ajaxPageTarget('data_table', 'banner', 'banner_lst' );
		}
		filterRecord();
	</script>
</body>
